    ...
    highlights: [
      {
        ...
        tone: 'tech',
        problem:
          '핵심 기능인 코드 에디터(CodeMirror)의 압축 전 번들 크기가 8MB에 달해, 페이지 로드가 눈에 띄게 느렸습니다.',
        solution:
          'bundle-analyzer로 분석해보니, 실제로 사용하지 않는 언어팩까지 모두 포함되어 있었습니다. 지원 언어를 주로 사용하는 언어로 한정하여 Tree Shaking을 적용하고, 에디터는 Lazy Loading을 통해 초기 번들과 분리하였습니다. Production 기준, 번들사이즈가 2.2MB에서 1.4MB로 줄였습니다.',
      },
      {
        label: '디자인 시스템',
        tone: 'tech',
